...
SECRET_KEY = 'django-insecure-m752g+m*%(hoqgw5jobol=@n#_udn2c4zfe!-37ewr#duj9&p%'
...
AUTH_USER_MODEL = 'accounts.CustomUserModel'  # Make sure the app name matches your app
LOGIN_URL = '/login/'
